...
from config_5_4 import root, bin_n, width_percent, height_percent, shape0, size0, tv_names

from hog_5_4 import cut, hog, resize_cut_hog_add_shape



svm_file = './svm_5_3_2.xml'
...
def classify_logo(imagePath):
    ...
    predicted_label = 0
    #print imagePath
    #imagePath=imagePath.decode('utf-8').encode('gb2312')
