...
from config_5_5 import root, bin_n, width_percent, height_percent, shape0, size0, tv_names

from hog_5_5 import cut, hog, resize_cut_hog_add_shape



svm_file = './svm_5_5.xml'
